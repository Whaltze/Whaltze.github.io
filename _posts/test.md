...
tags:
  - Blog
top_img: /img/test.png
cover: /img/test.png
date: 2025-02-16 22:42:45
---
...
<style>
    ...
    .author-box {
        ...
        padding: 20px;
        height: auto;
        /* border-bottom: 3px rgb(77, 152, 244); 蓝色 */
...
<div class="author-box">
    <div class="author-img">
        <img class="no-lightbox" src="https://s2.loli.net/2024/07/17/6BaSwvE4bMmltTO.jpg">
        <div class="green-dot"></div>
    </div>
    <div class="image-dot"></div>
    <p class="p center logo large"></p>
    <p class="p center small">一只热爱生活的小蓝鲸</p>
</div>

<div style="background-color: hsla(0, 0.00%, 49.00%, 0.25); color: white; padding: 10px; margin: 0 auto; margin-bottom: 20px; border-left: 1px hsla(213, 88.40%, 62.90%, 0.94); border-right: 1px hsla(213, 88.40%, 62.90%, 0.94); font-family: 'Comic Sans MS', cursive; font-size: 17px;  color:hsl(0, 0.00%, 93.70%);">
Greetings !
Welcome to
<a href="https://whaltze.github.io/">Whaltze</a>
...
<div style="background-color: hsla(0, 0.00%, 49.00%, 0.25); color: white; padding: 10px; margin: 0 auto; margin-bottom: 20px; border-left: 1px hsla(213, 88.40%, 62.90%, 0.94); border-right: 1px hsla(213, 88.40%, 62.90%, 0.94); text-align: center; font-family: 'Comic Sans MS', cursive; font-size: 17px;  color:hsl(0, 0.00%, 93.70%);">
家境贫寒,生活所迫 ······(此处省略1w字乞讨)
</div>

<div style="background-color: hsla(0, 0.00%, 0.00%, 0.00); color: white; padding: 10px; margin: 0 auto; margin-bottom: 20px; border-left: 1px hsla(213, 88.40%, 62.90%, 0.94); border-right: 1px hsla(213, 88.40%, 62.90%, 0.94); text-align: center; font-family: 'Comic Sans MS', cursive; font-size: 24px;  color:hsl(0, 0.00%, 93.70%);">
About Me
</div>



> 既然 你发现了这个页面 就说明 你对我的文章 还算颇有好感和认同 ! ! ! (嘿嘿) 
> 很高兴认识你, 下面是简单的自我介绍, 请查收 ! ! !



<div class="section left">
    <a href="http://localhost:4000/2024/07/10/Preface/">
        <img src="https://whaltze.github.io/img/0.png">
    </a>
    <div class="content">
